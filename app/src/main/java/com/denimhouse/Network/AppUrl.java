package com.denimhouse.Network;
...
public class AppUrl {
    ...
    public static String BASE_URL = "http://vertosys.com/denimhouse/webservices/";
    public static String SIGN_UP = "registration.php?";
    public static String SIGN_IN = "login.php?";
    public static String IMAGE_URL = "http://vertosys.com/denimhouse/admin/images/products/";
